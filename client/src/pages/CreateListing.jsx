    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-red-700 uppercase text-sm">
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-3 text-red-700 rounded-b-lg uppercase hover:opacity-90 disabled:opacity-80"
                >
                  Delete
                </button>
              </div>
          ...
          <button className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:bg-green-700 disabled:opacity-80 ">
            Create Listing
          </button>
        </div>
      </form>
